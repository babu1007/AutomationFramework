...
@Parameters({"browser","browserVersion","OperatingSystemName","OperatingSystemVersion","runningPlatform","TestDatapropertyFileName","WorkspacePath","AntParameter","pickBrowserBasedOnDay","UseNewBrowserForEachTest"})
	...
	FrameworkUtil.dictPropertyData.put("NAV.LIBRARY.LOCATION", "D:/Automation/SeleniumAutomationTesting/Libraries/");
	...
	try {
		...
		//FrameworkUtil.sResultPath = "D:/Automation/SeleniumAutomationTesting/Selenium Results/";
        if (AntParameter.contains("debug")){
            FrameworkUtil.sResultPath = "D:/Automation/SeleniumAutomationTesting/Selenium Results/debug/";
      }
